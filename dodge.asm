;Kyle Kline			email kkline2019@my.fit.edu
;Dodge the Lasers
;This is my entry for the assembly language game contest 2. In this game you are put in a grid and dodge the lasers for as 
